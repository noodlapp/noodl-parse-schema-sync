...
describe("relation tests", () => {
  ...
  it("can add two classes with relations to each other", async () => {
    // Add two classes that have relations to each other
    ...
    class1.addRelation("daRelation1", "MyClass2");
    await class1.update();

    class2.addRelation("daRelation2", "MyClass");
    await class2.update();
    ...
    expect(_trimSchema(result)).toEqual([
      ...
      },
      {
        ...
        fields: {
          ...
          updatedAt: { type: "Date" },
          ACL: { type: "ACL" },
          daRelation2: { type: "Relation", targetClass: "MyClass" },
        },
      },
      {
        className: "MyClass",
        fields: {
          ...
          updatedAt: { type: "Date" },
          ACL: { type: "ACL" },
          daRelation1: { type: "Relation", targetClass: "MyClass2" },
        },
      },
    ]);
  });
